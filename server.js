...
const io = new Server(server, {
  // 필요하면 CORS 옵션 조절 가능 (같은 도메인에서만 접속하니 기본값으로도 충분함)
  // cors: {
  //   origin: "*",
  // },
});
...
// ================================
const gameState = {
  players: [],           // [{socketId, nickname, board, bingoCount, isHost}]
...
io.on("connection", (socket) => {
  ...
  socket.on("join", (data) => {
    ...
    // 중복 닉네임 체크
    const isDuplicate = gameState.players.some(
